    ...
    public class UserServiceImpl implements UserService {
        ...
        @Override
        public List<UserEntity> buscarPorApellidoYTipo(String apellido, TypeUser tipoUsuario) {
            return userRepository.findByApellidosContainingIgnoreCaseAndTipoUsuario(apellido, tipoUsuario);
        }
